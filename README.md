...
|--------|-------|--------|---------|
| [`AstolfoVoice`](AstolfoVoice) | 0.3.0 | **Playable** | Proximity voice chat kompatibel SVC · sound physics raytrace v2 (smoothing + cache + lava) · range dinamis · noise cancellation spektral server-side · config auto-heal/migrate · playback mp3/ogg/wav + preset (PHONE/RADIO/MEGA/CAVE/**KAWAII**/**LOFI**) · location playback · list clickable · UI pink candy |
